...
- TUI 输入聚焦模型：[`../../../superpowers/specs/2026-07-24-tui-input-focus-model.md`](../../../superpowers/specs/2026-07-24-tui-input-focus-model.md)（cursor-visible 探针、白名单恢复、提交门禁、原生 focus 转场两个不变量）
