...
- 状态：draft
- 相关前作：
  - `docs/archive/superpowers/specs/2026-07-06-files-temporary-markdown-file-design.md`
  - `docs/archive/superpowers/specs/2026-07-09-files-project-status-item-design.md`
