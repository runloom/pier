...
- `docs/archive/superpowers/specs/2026-07-09-workbench-professional-ux-gap-analysis.md`（工作台非 BI 边界）
- `docs/archive/superpowers/specs/2026-07-10-workbench-responsive-ordered-grid-design.md`（物料 `params` 黑盒与多实例）
- `docs/archive/design/codex-workbench-widgets.md`（成本色与图表原语约定）
