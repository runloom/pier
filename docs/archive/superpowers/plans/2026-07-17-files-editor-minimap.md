...
**配套设计：** `docs/archive/superpowers/specs/2026-07-17-files-editor-minimap-design.md`
...
Plan 已保存到 `docs/archive/superpowers/plans/2026-07-17-files-editor-minimap.md`。
