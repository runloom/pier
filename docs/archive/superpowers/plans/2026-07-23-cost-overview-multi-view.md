...
**Spec:** `docs/archive/superpowers/specs/2026-07-23-cost-overview-multi-view-design.md`
...
Plan complete and saved to `docs/archive/superpowers/plans/2026-07-23-cost-overview-multi-view.md`.
