...
日期：2026-07-02
设计文档：`docs/archive/superpowers/specs/2026-07-02-plugin-configuration-and-statusbar-design.md` §3.2（主体）、§3.0（Phase 0 前置产物）、§3.1（复用 Phase 1 的 ContributionTable）、§4、§5、§6。
