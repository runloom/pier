...
- Scope is **P0 only** from `docs/archive/superpowers/specs/2026-07-09-workbench-professional-ux-gap-analysis.md` (P0.1–P0.7). Do not implement P1/P2 items in this plan.
