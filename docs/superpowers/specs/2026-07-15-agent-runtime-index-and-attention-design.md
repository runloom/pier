...
2026-09-05 后续修订：[工作台体验与人体工程学](./2026-09-03-workbench-ux-and-ergonomics-design.md) §5.4 / §9.3 将标题栏短列表升级为与命令面板一致的全量可检索 Index，并补同名消歧与选择稳定性。该修订待实施；下表的「短列表」描述原基线，不再作为容量上限。§6.1 的无常驻侧栏边界保留，扫描代价仍须用户验证，不视为已经解决。
