...
import { useMissionControlContextMenu } from "@/panel-kits/mission-control/mission-control-context-menu.ts";
...
function ContextMenuProbe({
  ...
  const menu = useMissionControlContextMenu(state);
  onRender?.();
...
describe("Mission Control native menu event boundaries", () => {
...
describe("useMissionControlContextMenu concurrent render isolation", () => {
