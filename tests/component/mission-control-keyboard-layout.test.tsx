...
import { applyKeyboardLayoutChange } from "@/panel-kits/mission-control/mission-control-keyboard-layout.ts";
...
const widgets: MissionControlPanelWidgetEntry[] = [
  { h: 3, id: "a", w: 4 },
  { h: 3, id: "b", w: 4 },
  { h: 3, id: "c", w: 4 },
];
...
describe("MissionControlPanel keyboard persistence", () => {
