...
import { resetTerminalPresentationReconcilerForTests } from "@/panel-kits/terminal/presentation-reconciler.ts";
import {
...
vi.mock(
  "@/panel-kits/terminal/layout-coordinator.ts",
  async (importOriginal) => {
    const actual =
      await importOriginal<
        typeof import("@/panel-kits/terminal/layout-coordinator.ts")
      >();
    return {
      ...actual,
