...
import {
  ...
  filterLibraryItems,
} from "@/panel-kits/workbench/workbench-library.ts";

const coreWidgets: readonly CoreWorkbenchWidgetDeclaration[] = [
  {
    category: "agent",
    defaultSize: { h: 3, w: 4 },
...
const coreReg: RendererWorkbenchWidgetRegistration = {
  component: () => null,
...
function buildItems(input?: {
  ...
  return buildWorkbenchLibraryItems({
...
describe("buildWorkbenchLibraryItems", () => {
