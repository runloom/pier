...
vi.mock("@/pages/settings/components/skills/candidate-lifecycle.ts", () => ({
...
import { discardActiveImportReview } from "@/pages/settings/components/skills/candidate-lifecycle.ts";
import {
  confirmDiscardSkillEditDrafts,
  leaveSkillsTransientState,
} from "@/pages/settings/components/skills/shared.tsx";
