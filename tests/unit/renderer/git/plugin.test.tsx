...
describe("git builtin plugin", () => {
  ...
  it("worktree renderer 插件只通过 plugin host API 访问宿主能力", async () => {
    const files = [
      ...
      "src/plugins/builtin/git/renderer/actions.ts",
      "src/plugins/builtin/git/renderer/branch-actions.ts",
      "src/plugins/builtin/git/renderer/command-helpers.ts",
      "src/plugins/builtin/git/renderer/merge-rebase-actions.ts",
      "src/plugins/builtin/git/renderer/sequencer-actions.ts",
      "src/plugins/builtin/git/renderer/stash-actions.ts",
