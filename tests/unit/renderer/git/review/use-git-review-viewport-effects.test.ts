...
import type { ReviewDocumentViewState } from "@plugins/builtin/git/renderer/review/document/projection.ts";
import { act, renderHook } from "@testing-library/react";
import { expect, it, vi } from "vitest";
import { useGitReviewViewportEffects } from "../../../../../src/plugins/builtin/git/renderer/hooks/use-viewport-effects.ts";
