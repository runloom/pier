...
const COMMIT_FORM_DIALOG_FILES = [
  ...
  "src/renderer/pages/settings/components/skills/skills-create-skill-dialog.tsx",
  ...
  "src/renderer/panel-kits/workbench/core-widgets/custom-card/custom-card-add-block-dialog.tsx",
] as const;

const WIDGET_SETTINGS_FILES = [
  "src/renderer/panel-kits/workbench/core-widgets/cost/cost-overview-settings.tsx",
  "src/renderer/panel-kits/workbench/core-widgets/custom-card/custom-card-settings.tsx",
] as const;
...
describe("dialog form governance", () => {
  it("documents commit vs live preference models in AGENTS.md", () => {
    ...
    expect(agents).toContain(
      "tests/unit/renderer/dialog-form-governance.test.ts"
    );
  });
  ...
  it("keeps AppContentDialogHost sticky footer chrome", () => {
    const host = source(
      "src/renderer/components/common/app-content-dialog-host.tsx"
    );
  ...
  it("keeps WorkbenchSettingsDialog as live-preference shell with optional sticky footer", () => {
    const dialog = source(
      "src/renderer/panel-kits/workbench/workbench-settings-dialog.tsx"
    );
  ...
  it("aligns widget settings to dialog commit-form field layout (vertical, full-width)", () => {
    ...
    const customCardEditor = source(
      "src/renderer/panel-kits/workbench/core-widgets/custom-card/custom-card-block-editor.tsx"
    );
