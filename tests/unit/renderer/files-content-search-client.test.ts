...
import { createFilesContentQueryClient } from "../../../src/plugins/builtin/files/renderer/files-content-search-client.ts";
import type { FilesContentSearchConditions } from "../../../src/plugins/builtin/files/renderer/files-content-search-params.ts";
