...
import { findWidgetDeclaration } from "@/panel-kits/workbench/workbench-panel-state-normalization.ts";
import {
  entry,
  params,
  renderState,
  ...
  widget,
  widgetIds,
} from "./workbench-panel-state-test-harness.ts";

describe("useWorkbenchPanelState v3", () => {
