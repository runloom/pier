...
import { useAgentComposer } from "@/panel-kits/terminal/hooks/use-agent-composer.ts";
import { pulseTerminalSurfaceSuppression } from "@/panel-kits/terminal/layout-coordinator.ts";
...
vi.mock("@/panel-kits/terminal/hooks/use-composer-open.ts", () => ({
...
vi.mock("@/panel-kits/terminal/layout-coordinator.ts", () => ({
