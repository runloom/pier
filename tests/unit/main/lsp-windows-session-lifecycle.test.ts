import type * as TerminationModule from "@main/services/lsp/lsp-process-termination.ts";
import { LspSessionHost } from "@main/services/lsp/lsp-session-host.ts";
import type * as SupervisorModule from "@main/services/lsp/lsp-windows-supervisor.ts";
import { WorkspaceLspPolicy } from "@main/services/lsp/workspace-lsp-policy.ts";
import { afterEach, describe, expect, it, vi } from "vitest";
import { FakeLspChild } from "./lsp-test-fixtures.ts";
...
vi.mock(
  "@main/services/lsp/lsp-process-termination.ts",
...
vi.mock(
  "@main/services/lsp/lsp-windows-supervisor.ts",
  async (importOriginal) => {
