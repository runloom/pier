...
import { readGitReviewPatch } from "@main/services/git-review/document/patch.ts";
import type { ReadGitReviewPatchOptions } from "@main/services/git-review/document/patch-contract.ts";
import type { GitReviewIndexExecutionBudget } from "@main/services/git-review/index/contract.ts";
...
vi.mock(
  "@main/services/git-review/temporary-root.ts",
  async (importOriginal) => {
    const original =
      await importOriginal<
        typeof import("@main/services/git-review/temporary-root.ts")
      >();
    return {
      ...original,
