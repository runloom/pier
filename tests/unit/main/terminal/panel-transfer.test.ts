...
describe("TerminalPanelTransfer", () => {
  ...
  async function load() {
    ...
    const { createTerminalPanelTransfer } = await import(
      "../../../../src/main/services/panel-transfer/terminal.ts"
    );
    return { createTerminalPanelTransfer, resolveOwner: routing.resolveOwner };
  }

  function baseDeps(args: {
    createTerminalPanelTransfer: typeof import("../../../../src/main/services/panel-transfer/terminal.ts").createTerminalPanelTransfer;
