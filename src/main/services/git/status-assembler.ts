...
import { detectMergedIntoDefault } from "./merged-detector.ts";
import { deriveCounts, parseGitStatus, splitNonEmptyLines } from "./parsers.ts";
import {
...
import { getRemoteSync } from "./remote-sync-registry.ts";
import {
  detectRepoState,
  type ExecGitFn,
  getStashCount,
} from "./status-detectors.ts";
