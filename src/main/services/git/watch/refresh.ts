...
import type { PrefetchedStatus } from "../status-assembler.ts";
import type { CreateGitWatchServiceOptions } from "./contract.ts";
import type { RefsSnapshot } from "./hub.ts";
import {
...
import type { RawWorktreeSnapshot } from "./signatures.ts";
