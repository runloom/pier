...
import type { FileDraftsService } from "../services/files/drafts-types.ts";
import { createPanelTransferFilesPort } from "../services/panel-transfer/file-drafts-port.ts";
import { createPanelTransferService } from "../services/panel-transfer/service.ts";
import { createTerminalPanelTransfer } from "../services/panel-transfer/terminal.ts";
...
export function wireAppCoreWindowAndPanelTransfer(input: {
  ...
  getTaskOutputBindings?:
    ...
    | undefined;
  getTaskService?:
    | (() => import("../services/tasks/service-types.ts").TaskService | null)
    | undefined;
