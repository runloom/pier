...
export const FILES_FILE_CLIPBOARD_CUT_COMMAND_ID = "pier.files.clipboard.cut";
export const FILES_FILE_CLIPBOARD_COPY_COMMAND_ID = "pier.files.clipboard.copy";
export const FILES_FILE_CLIPBOARD_PASTE_COMMAND_ID =
  "pier.files.clipboard.paste";
export const FILES_SEARCH_OPEN_HIT_COMMAND_ID = "pier.files.search.openHit";
export const FILES_SEARCH_COPY_PATH_COMMAND_ID = "pier.files.search.copyPath";
export const FILES_SEARCH_COPY_RELATIVE_PATH_COMMAND_ID =
  "pier.files.search.copyRelativePath";
export const FILES_SEARCH_COPY_MATCH_COMMAND_ID =
  "pier.files.search.copyMatchLine";
export const FILES_SEARCH_REVEAL_COMMAND_ID =
  "pier.files.search.revealInFinder";
