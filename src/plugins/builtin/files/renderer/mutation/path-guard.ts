...
import { listOpenDiskDocuments } from "../document/store.ts";
import type { FilesDocument } from "../document/types.ts";
import type { FileEditorViewSession } from "../editor/view-session.ts";
import { findAffectedOpenDocuments } from "./dirty-path-guard.ts";
