...
import { allocateExplicitDiskDocumentId } from "../document/paths.ts";
import {
  type FilesDocument,
...
import { nextUntitledIdentity } from "../document/untitled-identity.ts";
import type { FilesPanelTransferDeps } from "./transfer-deps.ts";
import {
