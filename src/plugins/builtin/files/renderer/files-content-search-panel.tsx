...
import { SearchPanelBody } from "./files-content-search-body.tsx";
import {
  contentSearchStatusText,
  FilesContentSearchChrome,
} from "./files-content-search-chrome.tsx";
import {
  type ContentQuerySnapshot,
  createFilesContentQueryClient,
} from "./files-content-search-client.ts";
import { openContentSearchHit } from "./files-content-search-open.ts";
import {
...
import { groupHitsByPath } from "./files-content-search-result-row.tsx";
