...
import { basename } from "../tree/action-utils.ts";
import { filePanelProjectRoot } from "../tree/preferences.ts";
import {
  createFilesPathQueryClient,
  type PathQuerySnapshot,
} from "./path-query-client.ts";
import { filesQuickOpenIcon } from "./quick-open-icon.tsx";
import { recordFilesPathMru } from "./quick-open-mru.ts";
