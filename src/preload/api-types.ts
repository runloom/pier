...
export type { ShellEnvironmentHostStatus } from "@shared/contracts/shell-environment.ts";

export interface PierShellEnvironmentAPI {
  refresh: () => Promise<
    import("@shared/contracts/shell-environment.ts").ShellEnvironmentHostStatus
  >;
  status: () => Promise<
    import("@shared/contracts/shell-environment.ts").ShellEnvironmentHostStatus
  >;
