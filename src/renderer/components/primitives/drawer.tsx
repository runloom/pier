...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Overlay
      className={cn(
        "app-no-drag data-open:fade-in-0 data-closed:fade-out-0 fixed inset-0 z-50 bg-black/30 data-closed:animate-out data-open:animate-in supports-backdrop-filter:backdrop-blur-sm",
        className
      )}
