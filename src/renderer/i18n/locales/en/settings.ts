...
export const settings = {
  ...
  projects: {
    ...
    tabMcp: "MCP",
    rulesHint:
      "Rules apply automatically in new agent sessions. Put on-demand workflows in Skills.",
    rulesLoading: "Loading rules…",
    rulesLoadFailed: "Couldn’t load rules",
    rulesSave: "Save",
    rulesSaveFailed: "Couldn’t save rules file",
    rulesDiscardTitle: "Discard unsaved changes?",
    rulesDiscardBody: 'Changes to rules in "{{name}}" will be lost.',
    rulesEnsureTitle: "Create this rules file?",
    rulesEnsureBody: 'Create "{{name}}"?',
    rulesEnsureFailed: "Couldn’t create rules file",
    rulesOpenFailed: "Couldn’t open rules file",
    rulesRevealFailed: "Couldn’t reveal in Finder",
    ...
    rulesTruncatedBody:
      "This file is over 512 KiB. Pier shows a read-only preview — open it in an external editor to change it.",
    ...
    rulesCursorMissingBody:
      "Pier won’t create .cursor/rules for you. Create it in Cursor or Finder, then reopen this tab.",
    rulesCreate: "Create {{name}}",
    rulesDirectoryTitle: "This path is a folder",
    rulesDirectoryBody:
      "Pier can show the folder in Finder, but doesn’t edit directory-shaped rules yet.",
    rulesOtherBody: "{{name}} exists but isn’t a normal editable file.",
    rulesOtherTitle: "{{name}} isn’t editable here",
    rulesEditorLabel: "Contents of {{name}}",
    mcpLoading: "Loading MCP servers…",
    mcpLoadFailed: "Couldn’t load MCP catalog",
    mcpActionFailed: "Couldn’t open MCP path",
    mcpNoticeBody:
      "Pier lists MCP servers from each agent’s configured recognition paths, and shows which installed agents can use each server. It won’t edit those files.",
    mcpColAgent: "Agent",
    mcpColPath: "Path",
    mcpColScope: "Scope",
    mcpColStatus: "Status",
    ...
    mcpEmptyDescription:
      "Pier didn’t find named MCP servers in configured agent recognition paths for this scope.",
    mcpRestartTitle: "Restart Pier to load MCP servers",
    mcpRestartDescription:
      "This window is still running an older main process that only listed config paths. Fully quit Pier / stop pnpm dev, start it again, then reopen this tab.",
  },
  ...
  row: {
    ...
    codeFontSizeDesc: "Font size for file editors and Git diffs (px), 8-32",
