export const terminal = {
  ...
  agentSession: {
    ...
    endedTitle: "智能体会话已结束",
    resumeFailedBody: "接回没有完成。可再试一次，或新开一场。",
    resumeFailedTitle: "未能接回上次会话",
    fieldAgent: "智能体",
    fieldCommand: "命令",
    fieldCwd: "工作目录",
    fieldDuration: "用时",
  ...
  ghosttyHost: {
    ...
    createFailed: "无法启动终端会话（{{error}}）。请重试。",
    createFailedUnknown: "无法启动终端会话。请重试。",
    errorRetry: "重试",
    relaunchFailed: "终端重启失败（{{error}}）。请关闭此标签页后重试。",
