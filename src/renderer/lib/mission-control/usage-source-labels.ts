...
const KNOWN_SOURCES: readonly SourceDisplay[] = [
  {
    i18nKey: "missionControl.widget.costOverview.sourceName.codex",
    sourceId: "codex-local-sessions",
  },
  {
    i18nKey: "missionControl.widget.costOverview.sourceName.claudeCode",
    sourceId: "claude-code-local-sessions",
  },
  {
    i18nKey: "missionControl.widget.costOverview.sourceName.opencode",
    sourceId: "opencode-local-sessions",
  },
  {
    i18nKey: "missionControl.widget.costOverview.sourceName.pi",
    sourceId: "pi-local-sessions",
  },
  {
    i18nKey: "missionControl.widget.costOverview.sourceName.omp",
...
export function listSupportedUsageSourceLabels(t: TFunction): string {
  return KNOWN_SOURCES.map((entry) => t(entry.i18nKey)).join(
    t("missionControl.widget.costOverview.sourceName.separator")
  );
}
