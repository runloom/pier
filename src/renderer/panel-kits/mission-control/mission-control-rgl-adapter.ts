...
export const MISSION_CONTROL_GRID_CONTAINER_PADDING = [0, 0] as const;

// noCompactor 只关闭压实，拖拽碰撞时仍会推开其它条目。这里允许 RGL
// 条目临时重叠，让有序布局算法独占重排策略。
export const MISSION_CONTROL_ORDERED_GRID_COMPACTOR = getCompactor(null, true);
...
export function missionControlPreviewOffset(
  baseItem: LayoutItem,
...
export function missionControlPreviewTransform(
